...
namespace SqlFunctions
{
    public class CTestSpecCommon
    {
       ...
       public  string strLastError = string.Empty;
        ...
        public List<SpecPerClass> lstSpecPerClass = new List<SpecPerClass>();
        ...
        public double ITU_Start_Freq { set; get; }
        public double ITU_Step_Freq { set; get; }
        ...
        public bool GetSpec(SqlCommand cmd, string pn, string temp)
        {
            ...
            try
            {
                ...
                this.Is_Wave = Convert.ToBoolean(dt.Rows[0]["is_wave"]);
                if (Is_Wave)
                {
                ...
                {
                    this.ITU_Start_Freq = Convert.ToDouble(dt.Rows[0]["itu_start_freq"]);
                    this.ITU_Step_Freq = Convert.ToDouble(dt.Rows[0]["itu_step_freq"]);
                }
...
//#endregion
            ...
            #region Get Per Class Spec

            SpecPerClass specPerClass = new SpecPerClass();
            specPerClass.GetSpec(cmd, this.SpecID, out lstSpecPerClass);
#endregion
            ...
            if (lstCrosstalkSpec.Count == lstLossSpec.Count && lstCrosstalkSpec.Count == lstPassbandSpec.Count && lstCrosstalkSpec.Count == lstPdlSpec.Count && lstCrosstalkSpec.Count == lstWavelengthSpec.Count && lstCrosstalkSpec.Count == lstFrequencySpec.Count && lstCrosstalkSpec.Count == (lstSpecPerClass.Count*MaxChannel))
            {
            ...
            {
                throw new Exception("Error! The count of class ID is different!");
            }
        }
